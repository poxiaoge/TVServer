...
public class Action {
	...
	public static final String START_COMMAND_SERVICE = "com.example.poxiaoge.tvserver.action.start.command";
	public static final String START_DMR_SERVICE = "com.example.poxiaoge.tvserver.action.start.dmr";
