...
//		newUri = "127.0.0.1:"+myTcpPort+"/"+itemId;
//		newUri = "D:\\TestJava\\test1\\src\\"+itemId;
		newUri = rootPath+File.separator+itemId;
//
...
//		myThread.setDaemon( true );
	...
	private class HTTPSession implements Runnable
	{
		...
		{
            System.out.println("in httpsession");
			mySocket = s;
			Thread t = new Thread( this );
			t.setDaemon( true );
            t.start();
            System.out.println("out httpsession");
		}
		...
		**/
			...
			throws InterruptedException
		{
			try {
				...
				int qmi = uri.indexOf( '?' );
				System.out.println("test by yi "+uri);
				if ( qmi >= 0 )
				{
